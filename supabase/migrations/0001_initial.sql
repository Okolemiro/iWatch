...
create policy "movie details owner access"
on public.movie_details for all
using (public.is_library_item_owner(library_item_id))
with check (public.is_library_item_owner(library_item_id));

create policy "tv show details owner access"
on public.tv_show_details for all
using (public.is_library_item_owner(library_item_id))
with check (public.is_library_item_owner(library_item_id));

create policy "seasons owner access"
...
create policy "episodes owner access"
